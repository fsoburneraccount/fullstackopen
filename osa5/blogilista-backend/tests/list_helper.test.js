...
const blogs = [
  { _id: '5a422a851b54a676234d17f7',
    ...
    author: 'Michael Chan',
    url: 'https://reactpatterns.com/', likes: 10,
    __v: 0 },
  { _id: '5a422aa71b54a676234d17f8',
    title: 'Go To Statement Considered Harmful',
    author: 'Edsger W. Dijkstra',
...
describe('total likes', () => {
  test('when list has 0 blogs the result equals 0', () => {
  ...
  test('when list has multiple blogs, the result equals the sum of their likes', () => {
    expect(listHelper.totalLikes(blogs)).toBe(42)
  })
})
...
describe('favorite blog', () => {
  ...
  test('when list has multiple blogs, the result is the most liked blog', () => {
...
describe('most blogs', () => {
  ...
  test('when list has multiple blogs, the result is the the author with most blogs', () => {
